...
class JobManagementTest {
	...
	public void testJobManagerWithPriority() throws InterruptedException {
		Job emailJob_1 = new Job("SEND_EMAIL", JobPriority.LOW);
		Job emailJob_2 = new Job("SEND_EMAIL", JobPriority.MEDIUM);
		Job streamJob_1 = new Job("STREAM_FILE", JobPriority.HIGH);
		Job streamJob_2 = new Job("STREAM_FILE", JobPriority.HIGH);
		Job streamJob_3 = new Job("STREAM_FILE", JobPriority.LOW);
		Job streamJob_4 = new Job("STREAM_FILE", JobPriority.HIGH);
		Job streamJob_5 = new Job("STREAM_FILE", JobPriority.HIGH);
